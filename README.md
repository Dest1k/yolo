...
> Держи пульт включённым, **MSP Override вешается на тумблер AUX** — сбросил тумблер
> и мгновенно вернул себе управление. При потере цели или выключенном слежении
...
4. На веб-панели нажми **пробел** (бейдж станет «LOCK ON») и пройди перед камерой — на
   тебе появится рамка. Людей несколько — **кликни мышкой по себе**.
5. Смотри по моторам (пропы сняты!): человек **справа** в кадре → дрон должен пытаться
   повернуть **вправо**; человек **далеко/мелкий** → тяга **вперёд**. Не туда —
   перезапусти Pi, добавив `FC_INVERT_YAW=1` и/или `FC_INVERT_PITCH=1`.
6. Сбрось тумблер **MSP Override**, **разармь**, выключи питание.
...
4. На веб-панели нажми **пробел** (бейдж станет «LOCK ON») и пройди перед камерой — на
   тебе появится рамка. Людей несколько — **кликни мышкой по себе**.
5. Смотри в Receiver-вкладке (или по моторам): человек **справа** в кадре → канал
...
**Angle/Horizon**. Взлети и держи **газ сам**. Включи **MSP Override**, нажми **пробел**,
кликни нужного человека — дрон начнёт доворачивать и держать дистанцию. **Чуть что —
сбрось тумблер**, управление мгновенно вернётся к тебе. Начинай с малых
`FC_MAX_YAW`/`FC_MAX_PITCH`.
